                                                ...
                                                fluidRow(
                                                  box(title="1. Imputation",
                                                      ...
                                                      selectInput(inputId="MyImpute",
                                                                     label="Do you want to make imputation before statistical test?",
                                                                     choices = c("YES","NO"),
                                                                     selected = "NO",
                                                                     multiple = FALSE),
...
server <- function(input, output, session) {
  ...
  output$MyKnit<-downloadHandler(
    ...
    content = function(file) {
      rmarkdown::render("RML_DIANN_MaxQprocess3.8.Rmd", 
                        output_file = file,
                        ...
                        params = list(MyFile=MyFile(),
                                      ...
                                      edata=edata(),
                                      fdata=fdata(),
                                      MyImputeMeth=if(input$MyStat=="NO"){NULL}else{c(input$MyImpute,input$MyImputeMeth)},
                                      phenodata=phenodata(),
                                      MyRegEx=input$MyRegEx,
                                      Pepdata=Pepdata(),
