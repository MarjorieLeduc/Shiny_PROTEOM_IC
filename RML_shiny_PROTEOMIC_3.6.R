                      ...
                      tabPanel("Statistics",
                               ...
                               conditionalPanel(condition = "input.MyStat == 'YES'",
                                                fluidRow(
                                                  ...
                                                  box(title="3. Filter of proteins before test",
                                                      width=3,
                                                      numericInput(inputId="TestpcFilter",
                                                                   label="Choose the pourcentage of valid values in at least one condition :",
                                                                   value=70),
                                                      numericInput(inputId="VVfilter",
                                                                   label="Choose the number of valid values in each condition (only used for Unpaired test):",
                                                                   value=3)),
                                                  box(title="4. Threasholds",
                                                      width=3,
      ...
      tabItem(tabName = "DescPlot",
              ...
              tabBox( width = 0,
                      ...
                      tabPanel("Normalisation",
                               helpText("This plot can be long to display."),
                               helpText("This plot is specific to DIANN search."),
...
server <- function(input, output, session) {
  ...
  output$MyKnit<-downloadHandler(
    filename = function() { 
        ...
        MyFileBase<-paste0(ProjectName,"_",MyStudWelch,MyAlternative,MyPaired,"_",PQ,MySignifVal,MySignifFC,".docx")
        MyFileBase
    },
    content = function(file) {
      rmarkdown::render("RML_DIANN_MaxQprocess3.6.Rmd", 
                        output_file = file,
